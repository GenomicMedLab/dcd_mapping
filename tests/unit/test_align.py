...
def scoreset_metadata_fixture():
    ...
    fixture_file = Path(__file__).parents[1].resolve() / "fixtures" / "scoreset_metadata.json"
...
def test_align(scoreset_metadata_fixture, mocker):
    """Test ``align()`` method.
    ...
    query_subranges = [[0, 52], [52, 232], [232, 309], [309, 463], [463, 595], [595, 750]]
    ...
    hit_subranges = [[37397802, 37397854], [37400114, 37400294], [37401601, 37401678], [37402434, 37402588], [37402748, 37402880], [37403170, 37403325]]
